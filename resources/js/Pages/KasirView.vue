                        ...
                        <div class="px-6 py-4 text-left modal-content">
                            ...
                            <form @submit.prevent="">
                                <div>
                                    ...
                                    <label>
                                        <input type="radio" class="w-5 h-5 text-indigo-600 focus:ring-indigo-500"
                                            name="radio" /><span class="ml-2 text-gray-700">Cash</span>
                                    </label>
                                    <label>
                                        <input type="radio" class="w-5 h-5 ml-3 text-indigo-600 focus:ring-indigo-500"
                                            name="radio" /><span class="ml-2 text-gray-700">QRis</span>
                                    </label>
                                </div>
                                <div class="mt-3">
