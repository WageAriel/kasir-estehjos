    ...
    >
      <div class="flex items-center justify-center mt-8">
        <div class="flex items-center">
          ...
          <span class="mx-2 text-2xl font-semibold text-white">Kasir Es Teh Jozz</span>
        </div>
      </div>
      ...
      <nav class="mt-10">
        ...
        <!-- Repeat similar blocks for Product, Category, Kasir, User, Question, Forms, Cards, Modal, and Blank -->

        <router-link
          class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          :class="[isActive('User') ? activeClass : inactiveClass]"
          to="/user"
        >
          <svg
            class="w-5 h-5"
        ...
        <router-link
          class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          :class="[isActive('Question') ? activeClass : inactiveClass]"
          to="/question"
        >
          <svg
            class="w-5 h-5"
        ...
        <!-- Repeat for Forms, Cards, Modal, and Blank -->
      </nav>
    </div>
  </div>
</template>
...
export default {
  setup() {
    ...
    const isActive = (route) => {
      console.log('Route:', route); // Debugging line
      return route && route.name === 'Dashboard'; // Adjust based on your logic
    };
